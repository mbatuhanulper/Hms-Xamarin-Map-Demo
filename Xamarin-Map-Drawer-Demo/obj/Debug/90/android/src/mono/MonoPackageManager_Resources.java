...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Xamarin-Map-Drawer-Demo.dll" comes first in this list. */
		"Xamarin-Map-Drawer-Demo.dll",
		"XAgconnectAgconnectCore-1.0.0.300.dll",
		...
		"XHmfTasks-1.3.3.300.dll",
		"XHmsBase-4.0.0.300.dll",
		"XHmsDynamicApi-1.0.13.300.dll",
		"XHmsLocation-4.0.2.300.dll",
